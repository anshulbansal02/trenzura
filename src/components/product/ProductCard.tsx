    ...
    <div className="group/card transition duration-300 ease-out">
      ...
      >
        <div className="relative overflow-hidden rounded-[1.1rem] bg-[var(--color-line)]">
          ...
          <div className="absolute bottom-3 left-3 right-3 flex items-center justify-between gap-3 rounded-full bg-[var(--color-paper)]/92 px-3 py-2 text-xs font-semibold text-[var(--color-ink)] opacity-0 shadow-sm backdrop-blur transition duration-200 ease-out group-hover:opacity-100 group-focus-visible:opacity-100">
      ...
      <div className="mt-3 flex items-center justify-between gap-3">
        <div className="min-w-0 text-xs text-[var(--color-muted)]">
          <span>{product.stockAvailable > 0 ? 'Ready to order' : 'Sold out'}</span>
        </div>
        <button
          type="button"
